...
using FastcodeinxBlog.Core.Commands;
using FastcodeinxBlog.Core.Database;
using FastcodeinxBlog.Core.Entities;
using FastcodeinxBlog.Website.Models.OutputModels.Administration;
...
namespace FastcodeinxBlog.Website.Controllers
{
    ...
    public partial class AdministrationController : Controller
    {
        ...
        public async virtual Task<ActionResult> Statistics()
        {
            ...
            var model = new FastcodeinxBlog.Website.Models.OutputModels.Administration.Downloads()
            {
        ...
        public async virtual Task<ActionResult> PerformPingbacks(Guid id)
        {
            ...
            var pingbackResults = FastcodeinxBlog.Common.Net.PingBack.PingBackService.PerformPingBack(
        ...
        /// <summary>
        /// Shows all <see cref="FastcodeinxBlog.Core.Entities.Image">Images</see>.
        /// </summary>
        /// <returns>A view showing all <see cref="FastcodeinxBlog.Core.Entities.Image">Images</see>.</returns>
