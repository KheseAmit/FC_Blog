...
using FastcodeinxBlog.Website.Models.OutputModels.Blog;
using MvcSiteMapProvider.Web.Mvc.Filters;
using FastcodeinxBlog.Common.Linq;
using FastcodeinxBlog.Common.Net.Mvc;
...
namespace FastcodeinxBlog.Website.Controllers
{
    ...
    public partial class BlogController : Controller
    {
        ...
        /// <returns>A view showing a single <see cref="BlogEntry"/>.</returns>
        [SiteMapTitle("Header")]
        [FastcodeinxBlog.Common.Net.Mvc.SpamProtection(4)]
        ...
        public async virtual Task<ActionResult> Feed()
        {
            ...
            return new FastcodeinxBlog.Common.Net.Mvc.Feed.RssSyndicationFeedActionResult(feed);
        }
