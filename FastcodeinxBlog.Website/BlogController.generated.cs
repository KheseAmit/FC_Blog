...
namespace FastcodeinxBlog.Website.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_BlogController : FastcodeinxBlog.Website.Controllers.BlogController
    {
        ...
        [NonAction]
        partial void EntryOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string id, FastcodeinxBlog.Core.Entities.BlogEntryComment blogEntryComment);

        [NonAction]
        public override System.Threading.Tasks.Task<System.Web.Mvc.ActionResult> Entry(string id, FastcodeinxBlog.Core.Entities.BlogEntryComment blogEntryComment)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Entry);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "id", id);
