...
{
    public static FastcodeinxBlog.Website.Controllers.AboutController About = new FastcodeinxBlog.Website.Controllers.T4MVC_AboutController();
    public static FastcodeinxBlog.Website.Controllers.AdministrationController Administration = new FastcodeinxBlog.Website.Controllers.T4MVC_AdministrationController();
    public static FastcodeinxBlog.Website.Controllers.BlogController Blog = new FastcodeinxBlog.Website.Controllers.T4MVC_BlogController();
    public static FastcodeinxBlog.Website.Controllers.ErrorController Error = new FastcodeinxBlog.Website.Controllers.T4MVC_ErrorController();
    public static FastcodeinxBlog.Website.Controllers.ImprintController Imprint = new FastcodeinxBlog.Website.Controllers.T4MVC_ImprintController();
    public static FastcodeinxBlog.Website.Controllers.LoginController Login = new FastcodeinxBlog.Website.Controllers.T4MVC_LoginController();
